...
import MailingList from "@/components/registration/MailingList";
...
export default async function Home() {
  ...
  const eventsByDay = scheduledEvents.reduce(
    (acc: Record<string, (typeof events.$inferSelect)[]>, event) => {
  ...
  return (
    <div className="antialiased md:subpixel-antialiased w-full overflow-x-hidden">
      {/*<Navbar />*/}
      <MLHBadge />
      ...
      <main className="min-h-screen relative">
        ...
        <div className="relative">
            ...
            <div className="flex flex-col items-center justify-center gap-8">
              ...
              <div className="flex flex-col md:flex-row gap-4 max-w-3xl">
                <div className="bg-[#F9EA8240] w-full rotate-2 hover:rotate-0 transition-transform duration-200 ease-in-out text-black rounded-xl p-4 flex flex-col gap-4">
                  ...
                  <div>
                    For Fall 2025, sunhacks will be hosted as a fully in-person
          ...
          <section className="bg-[#2F0007] py-16">
            ...
            <div className="container mx-auto px-4">
              ...
              <p className="text-lg text-center text-white mb-8">
                Explore our state-of-the-art hardware lab, equipped with the
          ...
          <section className="bg-[#FFF4B8] py-16 hidden">
            ...
            <div className="container mx-auto px-4">
              <h2 className="text-4xl md:text-5xl font-bold text-center mb-8 text-[#2F0007]">
                Prize Tracks
              </h2>
        ...
        <footer className="bg-[#2F0007] text-white py-8">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center">
              <span className="text-white">Made by sunhacks with love ♥</span>
            </div>
          </div>
        </footer>
      </main>
